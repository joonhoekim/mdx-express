---
title: "죽은 코드 3종: 용암, 시체, 닻"
subtitle: "제거해야 하는데 아무도 건드리지 못하는 코드들"
description: "Lava Flow·Dead Code·Boat Anchor 세 안티패턴의 정의와 차이, 감지 방법, 안전한 삭제 프로세스와 도구 활용법을 TypeScript 예제로 설명한다."
---
