---
title: "Proxmox NAS 구축 & 디스크 관리 팁 정리"
subtitle: "NAS를 굴리며 손에 익은 명령어들을 모아두다"
description: "Proxmox 기반 NAS를 운영하며 쓰는 디스크 관리 명령어를 정리한다. LXC 컨테이너에 ZFS 바인드 마운트, 외장 디스크 마운트, rsync 파일 복사, screen 백그라운드 작업, I/O 모니터링, SMB·NFS 공유 설정과 ZFS 핵심 개념을 다룬다."
---
