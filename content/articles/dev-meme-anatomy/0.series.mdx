---
title: "개발 밈 해부학: 웃기지만 슬픈 개발자의 자화상"
subtitle: "밈은 거짓말을 하지 않음. 우리가 웃는 이유는 그게 사실이기 때문임."
description: "개발자 밈을 하나씩 해부해 그 뒤에 숨은 기술적 원인을 설명하는 시리즈의 개요. 환경 문제, 버그의 정치학, 위험한 명령어, 테스트의 현실 등 6편의 구조와 목차를 담았다."
---
