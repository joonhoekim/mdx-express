---
title: "벡터, 내적, 유사도"
subtitle: "화살표, 배열, 점 — 셋은 같은 것을 다른 각도에서 본 것이다"
description: "벡터를 보는 세 가지 관점, 벡터의 덧셈·스칼라곱·크기 연산, 내적이 '두 벡터가 얼마나 같은 방향인가'를 뜻하는 이유, 그리고 코사인 유사도가 검색 엔진의 기반이 되는 과정을 다룬다."
order: 9
