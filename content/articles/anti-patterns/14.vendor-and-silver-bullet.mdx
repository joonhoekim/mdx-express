---
title: "벤더 종속과 은탄환: 기술 선택의 함정"
subtitle: "\"이 기술 하나면 다 해결됩니다\" — 아, 네"
description: "Vendor Lock-in·Silver Bullet·Architecture Astronaut 세 안티패턴의 정의와 사례, 추상화 레이어·트레이드오프 분석·YAGNI를 통한 완화법과 건강한 기술 의사결정 절차를 설명한다."
---
