...
subtitle: "모바일 채팅 서비스를 처음부터 확장 가능하게"
description: "React Native 프론트엔드와 NestJS 백엔드로 모바일 중심 실시간 채팅 서비스를 설계하는 종합 가이드다. 핵심 기술 스택, 전체 아키텍처 구성, WebSocket 통신, Redis와 MongoDB를 활용한 확장 가능한 시스템 설계를 다룬다."
tags: ["Node.js", "NestJS", "React Native", "Architecture", "Chat", "WebSocket", "Redis", "MongoDB"]
---
