---
title: "God Object: 모든 걸 아는 신(神) 클래스"
subtitle: "시스템 전체를 지배하는 만능 클래스의 최후"
description: "God Object 안티패턴의 정의와 발생 과정, 단일 책임 원칙 위반 사례, 책임별 클래스 분리와 의존성 주입을 통한 리팩토링 방법을 TypeScript 예제로 설명한다."
---
