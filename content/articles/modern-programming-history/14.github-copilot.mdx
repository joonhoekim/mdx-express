---
title: "Episode 14: \"GitHub Copilot: AI 페어 프로그래머의 등장\""
subtitle: "코딩의 미래, 인간과 AI의 협업"
description: "Transformer와 Codex로 시작된 AI 코드 생성, 개발자 역할의 변화와 저작권 논란, Context Window와 토큰 비용의 현실적 제약, 그리고 AI와 효과적으로 협업하는 전략을 다룬다."
---
