---
title: "Episode 7: \"타입스크립트: 자바스크립트에게 날개를 달아주다\""
subtitle: "마이크로소프트가 구원한 동적 타입의 혼돈"
description: "동적 타입 자바스크립트의 한계, 안더스 하일스베르그와 타입스크립트의 탄생, 점진적 타입 시스템과 구조적 타이핑의 설계 철학, Angular·Vue의 전향과 생태계 정복 과정을 다룬다."
---
