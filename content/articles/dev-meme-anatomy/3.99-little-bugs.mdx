---
title: "\"99 little bugs in the code\" — 버그 수정이 버그를 낳는 이유"
subtitle: "99개의 버그를 벽에 붙여놓고, 하나를 떼어서 고치면, 127개의 버그가 벽에."
description: "회귀 버그가 발생하는 메커니즘과 사이드 이펙트·커플링이 만드는 연쇄 반응, 인터페이스 변경이 일으키는 도미노 현상, 회귀 테스트·방어적 프로그래밍·git bisect로 회귀를 줄이는 전략을 다룬다."
---
