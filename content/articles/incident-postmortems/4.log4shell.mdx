---
title: "Log4Shell (2021) — 역사상 최악의 제로데이"
subtitle: "로깅 라이브러리에 숨어 있던 원격 코드 실행 취약점, 마인크래프트 채팅에서 발견되다"
description: "Log4j의 JNDI Lookup 원격 코드 실행 취약점(CVE-2021-44228)의 공격 원리와 WAF 우회 패턴을 분석한다. 패치 타임라인, 데이터·코드 혼합이라는 근본 원인, SBOM과 공급망 공격 대응 전략을 다룬다."
---
