---
title: "개발 무림 세계관 — 프레임워크와 언어를 무협으로 설명한다면"
subtitle: "10년 공들인 내공이 신기술 하나에 쓸모없어지는 강호"
description: "프로그래밍 언어와 프레임워크를 무협 문파에 빗대는 시리즈의 세계관 소개. 무림 세력도, 개발 세계와 무협의 구조 매핑, 백엔드부터 AI까지 8개 무림의 전체 목차를 담았다."
---
