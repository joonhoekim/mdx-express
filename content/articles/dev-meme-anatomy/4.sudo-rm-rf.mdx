---
title: "\"sudo rm -rf /\" — 삭제 사고의 역사"
subtitle: "인류 역사상 가장 비싼 키 조합."
description: "Pixar·GitLab·Amazon S3의 유명한 삭제 사고와 rm -rf의 동작 원리 및 보호 장치, 배포 스크립트·크론잡·DB 마이그레이션의 실제 사고 시나리오, 3-2-1 백업 규칙과 Soft Delete 등 삭제 방지 패턴을 다룬다."
---
