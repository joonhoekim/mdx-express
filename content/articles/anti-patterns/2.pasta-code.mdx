---
title: "파스타 코드 3형제: 스파게티, 라자냐, 라비올리"
subtitle: "구조가 없거나, 너무 많거나, 너무 잘게 쪼개졌거나"
description: "스파게티·라자냐·라비올리 코드의 정의와 원인, 각 패턴의 코드 예시와 개선 방법, 그리고 셋 사이에서 적절한 구조의 균형점을 찾는 법을 TypeScript 예제로 설명한다."
---
