---
title: "\"I don't always test my code, but when I do, I do it in production\" — 테스트의 현실"
subtitle: "테스트를 안 짜는 건 게으른 게 아님. 일정이 허락하지 않는 거임. (본인 피셜)"
description: "테스트를 안 짜는 실제 이유들과 프로덕션 테스트가 일어나는 상황, 테스트 피라미드의 이상과 현실(아이스크림 콘), Unit·Integration·E2E 테스트 작성법, Feature Flag와 모니터링, 테스트 문화를 만드는 로드맵을 다룬다."
---
