---
title: "레거시 리팩토링 실전 — 칼을 뽑았으면 무라도 썰어야지"
subtitle: "\"리팩토링 해야 하는데...\" 라고 말한 지 6개월째인 사람 손들어"
description: "레거시 코드를 안전하게 리팩토링하는 실전 가이드. Strangler Fig 패턴, Characterization/Golden Master 테스트, God Function 분리, 콜백·조건문 리팩토링 예제, 리팩토링 vs 리라이트 판단 기준과 실전 규칙을 다룬다."
---
