---
title: "상속 지옥: 거부, 병렬, 요요"
subtitle: "상속을 잘못 쓰면 이런 지옥이 펼쳐진다"
description: "Refused Bequest·Parallel Inheritance Hierarchies·Yo-yo Problem 세 상속 안티패턴의 정의와 원인, 합성과 인터페이스를 통한 해결 방법, 상속보다 합성을 선호해야 하는 이유를 TypeScript 예제로 설명한다."
---
