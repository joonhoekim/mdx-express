---
title: "\"It's not a bug, it's a feature\" — 버그와 기능의 경계"
subtitle: "모든 버그는 문서화되는 순간 기능이 됨."
description: "버그가 기능이 된 유명 사례들과 JIRA 티켓의 정치학, '의도된 동작'이 진실인 경우와 거짓말인 경우, 묵시적 타입 변환·정렬·경계 조건이 만드는 함정, 버그와 기능을 판별하는 기준을 다룬다."
---
