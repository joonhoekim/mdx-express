---
title: "커플링 냄새 3종: 부러움, 밀착, 중개인"
subtitle: "클래스 간 관계가 이상할 때 나는 냄새들"
description: "Feature Envy·Inappropriate Intimacy·Middle Man 세 커플링 코드 냄새의 정의와 차이, 메서드 이동·캡슐화·중개인 제거를 통한 해결 방법과 코드 리뷰 감지법을 TypeScript 예제로 설명한다."
---
