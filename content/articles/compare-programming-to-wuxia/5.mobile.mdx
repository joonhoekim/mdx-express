---
title: "4부: 모바일 무림"
subtitle: "iOS vs Android, 그리고 통일을 꿈꾸는 크로스플랫폼"
description: "둘로 갈라진 모바일 무림을 다룬다. iOS 진영(Objective-C·Swift·SwiftUI), Android 진영(Java·Kotlin·Jetpack Compose), 크로스플랫폼(Flutter·React Native·KMP), 그리고 앱스토어 심사라는 모바일만의 제약을 소개한다."
---
