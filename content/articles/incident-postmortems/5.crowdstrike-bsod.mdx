---
title: "CrowdStrike 블루스크린 (2024) — 보안 업데이트가 전 세계 윈도우를 죽이다"
subtitle: "2024년 7월 19일, 커널 레벨 보안 드라이버의 잘못된 업데이트가 850만 대의 윈도우를 블루스크린으로 만든 사건"
description: "2024년 CrowdStrike Falcon 채널 파일 결함으로 인한 전 세계 윈도우 BSOD 사태를 분석한다. 커널 드라이버의 입력 검증 부재, BitLocker 복구 교착 상태, 커널 접근 권한 논쟁, Staged Rollout의 필요성을 다룬다."
---
