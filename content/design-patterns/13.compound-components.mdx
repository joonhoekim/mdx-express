...
subtitle: "사용자에게 제어권을 돌려주는 LEGO 철학"
description: "여러 하위 컴포넌트를 조립해 하나의 기능을 완성하는 Compound Components 패턴을 다룬다. Props Hell의 문제점, Context 기반 암묵적 상태 공유, Dropdown 직접 구현, 안티패턴과 해결법, Next.js Server Components 적용, 실무 라이브러리 사례, 적용 판단 기준을 예제로 설명한다."
---
