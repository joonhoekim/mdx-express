---
title: "npm left-pad 사태 (2016) — 11줄 코드가 세상을 멈추다"
subtitle: "한 개발자의 분노, 패키지 삭제 하나로 React, Babel, 수천 개 프로젝트가 동시에 빌드 실패한 사건"
description: "2016년 npm left-pad 사태의 발단(kik 이름 분쟁)과 영향을 분석한다. npm unpublish 정책 부재, 마이크로 패키지 문화, 의존성 트리 문제를 짚고 lock 파일·private registry·padStart 표준화 등 사건 이후의 변화를 다룬다."
---
