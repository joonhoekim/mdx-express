...
subtitle: "편의를 얻는 대신 무엇을 내주는지 알고 쓰기"
description: "sudo와 polkit에서 비밀번호 입력을 생략하는 방법을 다룬다. sudoers의 NOPASSWD 설정과 polkit 규칙 파일 작성, 특정 명령어·액션에만 적용하는 방법, 그리고 이 설정에 따르는 보안 위험과 두 인증 시스템의 차이를 설명한다."
---
