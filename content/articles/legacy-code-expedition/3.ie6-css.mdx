---
title: "IE6 호환 CSS — 조건부 주석과 핵의 고고학"
subtitle: "\"이 레이아웃 왜 IE에서만 깨지죠?\" — 2000년대 프론트엔드 개발자의 매일 아침 인사"
description: "IE6 시대의 CSS 핵 — 박스모델 핵, 조건부 주석, star/underscore hack, hasLayout, 클리어픽스, PNG 투명도 필터 — 과 IE6 특유의 버그들을 정리하고, Flexbox·Grid 기반 모던 CSS로의 진화 과정을 비교한다."
---
