---
title: "복잡성과 추측성: 없어도 될 복잡함을 만드는 방법"
subtitle: "\"나중에 필요할 수도 있잖아\" — 그 나중은 안 옴"
description: "Accidental Complexity·Arrow Anti-Pattern·Speculative Generality 세 안티패턴의 정의와 원인, Guard Clause와 YAGNI를 통한 해결 방법, 실무에서 흔한 우발적 복잡성 사례를 TypeScript 예제로 설명한다."
---
