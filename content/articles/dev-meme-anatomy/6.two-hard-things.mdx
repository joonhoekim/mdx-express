---
title: "\"There are only 2 hard things in CS\" — 캐싱, 네이밍, 그리고 Off-by-one"
subtitle: "컴퓨터 과학에서 어려운 건 딱 2가지임: 캐시 무효화, 이름 짓기, 그리고 Off-by-one 에러."
description: "캐시 무효화가 어려운 이유와 분산 환경의 캐시 스탬피드, 좋은 네이밍의 원칙과 도메인 언어, Off-by-one 에러의 다양한 형태와 펜스포스트 문제, 경계값 테스트로 이를 방지하는 법을 다룬다."
---
