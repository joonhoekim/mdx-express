---
title: "순환 의존성: 뫼비우스의 코드"
subtitle: "A가 B를 부르고, B가 C를 부르고, C가 다시 A를 부르면?"
description: "순환 의존성 안티패턴의 정의와 문제점, 의존성 역전·이벤트 기반·중간 모듈 추출을 통한 해결 방법, CommonJS와 barrel export의 함정 및 감지 도구를 TypeScript 예제로 설명한다."
---
