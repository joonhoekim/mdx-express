---
title: "Episode 17: \"웹3와 탈중앙화: 블록체인이 바꿀 인터넷\""
subtitle: "중앙서버 없는 애플리케이션의 가능성과 한계"
description: "비트코인 스크립트에서 스마트 컨트랙트로의 진화, Solidity와 The DAO 해킹, DApp 개발의 이상과 현실, NFT·DeFi 같은 새로운 애플리케이션 모델, 그리고 웹3의 허와 실을 개발자 시각에서 다룬다."
---
