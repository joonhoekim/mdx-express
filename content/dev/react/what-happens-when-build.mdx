---
title: "Next.js 빌드 과정: 개발 코드가 프로덕션으로 변환되는 여정"
subtitle: "next build 한 줄 뒤에서 벌어지는 일들"
description: "next build가 개발 코드를 프로덕션 애플리케이션으로 변환하는 과정을 다룬다. 최소화·트랜스파일·번들링의 개념, Next.js의 컴파일·번들링·최적화·정적 생성 단계, 출력 파일 구조, 그리고 CRA·Vite·순수 Webpack과의 빌드 과정 비교를 설명한다."
---
