---
title: "AngularJS → Angular — 같은 이름, 완전히 다른 프레임워크"
subtitle: "Angular 2가 나왔을 때 AngularJS 개발자들의 표정은 '내 집이 철거된다'는 통보를 받은 것과 같았음."
description: "AngularJS의 양방향 바인딩·DI 혁신과 $scope 지옥·dirty checking 등의 한계, Angular 2로의 급진적 전환이 부른 커뮤니티 분열을 다룬다. React가 왕좌를 차지한 과정과 Angular의 현재 위치, 마이그레이션 교훈도 정리한다."
---
