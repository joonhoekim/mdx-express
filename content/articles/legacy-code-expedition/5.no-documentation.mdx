---
title: "문서 없는 코드베이스 생존기 — '이 코드 짠 사람 퇴사했는데요'"
subtitle: "\"인수인계서요? 아 그거 구두로 했는데... 그 사람 지금 안 계시고...\""
description: "문서·테스트·인수인계가 없는 프로젝트를 분석하는 코드 고고학 기법 — git blame/log, 아키텍처 추론, 테스트·DB·API에서 비즈니스 로직 추출 — 과 온보딩 절차, ADR·주석·온보딩 문서 작성법을 다룬다."
---
