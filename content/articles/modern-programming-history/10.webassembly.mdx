---
title: "Episode 10: \"WebAssembly: 웹 성능의 마지막 퍼즐\""
subtitle: "브라우저 안에서도 네이티브급 성능을"
description: "Flash의 몰락과 웹 성능의 갈증, JavaScript 부집합 asm.js의 실험, 브라우저 벤더들이 합의한 WebAssembly 표준의 등장, 게임·Photoshop·데이터베이스부터 WASI와 엣지 컴퓨팅까지의 활용 사례를 다룬다."
---
