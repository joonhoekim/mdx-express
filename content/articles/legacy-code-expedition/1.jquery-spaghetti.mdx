---
title: "jQuery 스파게티 — 2010년대의 프론트엔드 유적"
subtitle: "$(document).ready(function() { 여기서부터 지옥이 시작됨 })"
description: "2010년대 jQuery 코드의 전형적인 안티패턴 — 콜백 지옥, 이벤트 중복 바인딩, DOM 직접 조작, 플러그인 충돌, 숨겨진 상태 저장소 — 을 살펴보고 모듈 패턴·Promise·React 점진 도입으로 현대화하는 마이그레이션 전략을 다룬다."
---
