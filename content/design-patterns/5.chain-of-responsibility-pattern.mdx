...
subtitle: "내가 처리할 수 있으면 처리, 아니면 다음으로"
description: "요청을 처리할 수 있는 핸들러들을 체인으로 연결하는 Chain of Responsibility 패턴을 다룬다. 조건문 폭발의 문제점, 다단계 결재 승인·요청 검증 파이프라인·API 미들웨어 체인 구현, 동적 체인 구성, 적용 시점과 피해야 할 경우를 예제로 설명한다."
