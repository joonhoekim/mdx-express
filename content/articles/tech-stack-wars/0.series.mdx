---
title: "기술 스택 전쟁사: 개발자들의 끝나지 않는 성전"
subtitle: "\"니가 쓰는 기술이 틀렸다\" — 모든 개발자 커뮤니티의 영원한 떡밥"
description: "에디터·코딩 스타일·API 설계·데이터베이스·저장소·프론트엔드·인프라까지, 개발자 커뮤니티의 대표적인 기술 스택 논쟁 7편을 다루는 시리즈의 개요와 목차, 전쟁의 공통 패턴을 소개한다."
---
