---
title: "\"Works on my machine\" — 환경 차이의 과학"
subtitle: "개발자의 가장 유명한 변명이자, Docker가 탄생한 이유."
description: "\"내 컴퓨터에선 되는데\" 밈의 기원과 OS·런타임 버전·환경변수·의존성·시스템 의존성 차이가 발생하는 원인, Docker가 이를 해결한 방식과 한계, CI/CD와 환경변수 검증으로 환경 차이를 잡는 법을 다룬다."
---
