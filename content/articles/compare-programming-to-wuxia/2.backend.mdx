---
title: "1부: 백엔드 무림"
subtitle: "정통 내공부터 은둔고수까지, 서버 세계의 문파 지도"
description: "백엔드 프레임워크들을 무협 문파에 빗대 소개한다. Spring 소림사, NestJS 속성과정, Express 재야무인, FastAPI/Django 도가, Go 실전무인, Rust 은둔고수, Rails 전설의 원로를 다룬다."
---
