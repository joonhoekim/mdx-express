---
title: "Episode 8: \"러스트: 메모리 안전성 혁명\""
subtitle: "시스템 프로그래밍의 새로운 성배"
description: "C/C++ 메모리 버그의 저주, 모질라 Servo 프로젝트에서 시작된 Rust, Ownership과 Borrowing이 컴파일 타임에 안전성을 보장하는 원리, Discord·Microsoft·Linux 커널 등 산업계 채택 사례를 다룬다."
---
