...
subtitle: "HOC의 Wrapper Hell을 넘어선 로직 재사용"
description: "컴포넌트 간 상태 로직을 재사용하는 Render Props와 Custom Hooks 패턴을 다룬다. 두 방식의 개념과 HOC와의 비교, useDebounce·useLocalStorage·useIntersectionObserver 구현, Custom Hooks 안티패턴, Next.js Server Components 시대의 Hook 사용법, 성능 최적화를 예제로 설명한다."
---
