---
title: "React Suspense와 Lazy: 스마트한 코드 분할로 성능 최적화하기"
subtitle: "당장 필요 없는 코드는 당장 보내지 않는다"
description: "React.lazy와 Suspense를 활용한 코드 분할을 다룬다. 라우트·기능·조건부 분할 패턴, 중첩 Suspense 경계와 에러 경계, 프리로딩과 청크 이름 지정, 재시도 로직, Next.js dynamic과의 비교, 번들 분석까지 성능 최적화 관점에서 설명한다."
---
