---
title: "2부: 프론트엔드 무림"
subtitle: "종교전쟁 수준의 문파 싸움, 그리고 빌드툴·상태관리·CSS 내전"
description: "프론트엔드 사대문파(React·Vue·Angular·Svelte)와 jQuery·htmx, 빌드툴(Webpack·Vite·Turbopack), 상태관리(Redux·Zustand·Jotai), CSS(Bootstrap·Tailwind·CSS Modules·styled-components)를 무협으로 풀어낸다."
---
