---
title: "jQuery → 쇠퇴와 유산 — 아직도 인터넷의 77%에 깔려있는 좀비"
subtitle: "\"jQuery는 죽었다고? 니가 오늘 방문한 웹사이트 10개 중 7개에 jQuery가 있음. 좀비도 이 정도면 대단한 거임.\""
description: "브라우저 전쟁 시대에 jQuery가 해결한 문제와 전성기, 네이티브 API·프레임워크의 등장으로 인한 쇠퇴 과정을 다룬다. jQuery가 아직 필요한 곳, 바닐라 JS 마이그레이션 방법, querySelector 등 jQuery가 남긴 유산을 정리한다."
---
