---
title: "Episode 12: \"클라우드 네이티브: 서버리스의 등장\""
subtitle: "서버를 관리하지 않고 코드만 배포하는 꿈"
description: "AWS Lambda의 등장과 FaaS 모델, NoOps의 이상과 Cold Start·벤더 종속 같은 현실적 한계, JAMstack과 Vercel의 부상, CDN을 컴퓨팅 플랫폼으로 바꾼 엣지 컴퓨팅까지 서버리스 10년사를 다룬다."
---
