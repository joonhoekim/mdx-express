---
title: "KDE Neon에서 한국어 입력 설정하기"
subtitle: "\"rㅏ나다\"에서 벗어나는 fcitx5 설정법"
description: "KDE Neon과 Ubuntu에서 fcitx5로 한국어 입력을 설정하는 방법을 다룬다. fcitx5 설치와 기본 입력기 지정, 환경 변수와 KDE 시스템 설정, 한글 입력기 추가, 입력 오류 문제 해결, 그리고 부가 도구인 Touchcursor Linux 설치까지 설명한다."
---
