---
title: "React 생명주기의 진화: 클래스에서 훅까지"
subtitle: "componentDidMount의 시대는 가고, useEffect가 왔다"
description: "클래스 컴포넌트의 생명주기 메서드부터 useEffect 기반 훅까지 React 생명주기 관리의 변천을 다룬다. 의존성 배열의 이해, 데이터 페칭·이벤트·타이머 패턴, useLayoutEffect, 커스텀 훅 분리, 클래스에서 함수형으로의 마이그레이션과 성능 최적화를 설명한다."
---
