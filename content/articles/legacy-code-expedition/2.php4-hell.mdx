---
title: "PHP 4 시절 코드 — include 지옥과 글로벌 변수의 향연"
subtitle: "register_globals = On 이 한 줄이 인류에게 가져다 준 재앙의 크기는 측정 불가"
description: "PHP 4 레거시 코드의 보안 재앙 — register_globals, SQL Injection, include 지옥, 평문 비밀번호, 한국 PHP 생태계의 특수성 — 을 짚고, PHP 4부터 8까지의 진화 과정과 PDO·Prepared Statement 기반 현대화 가이드를 제시한다."
---
