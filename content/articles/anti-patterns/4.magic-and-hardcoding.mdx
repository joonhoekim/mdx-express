---
title: "매직 넘버와 하드코딩: 코드 속 수수께끼"
subtitle: "이 86400은 뭐고 저 3은 또 뭐임?"
description: "Magic Number/String과 Hard Coding 안티패턴의 정의와 차이, 상수화·환경 변수·설정 모듈을 통한 해결 방법, 흔한 변명과 반박을 TypeScript 예제로 설명한다."
---
