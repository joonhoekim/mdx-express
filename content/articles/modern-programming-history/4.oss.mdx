---
title: "Episode 4: \"오픈소스의 승리: GPL에서 MIT까지\""
subtitle: "코드 공유의 철학이 산업을 바꾸다"
description: "리차드 스톨만의 자유 소프트웨어 운동과 GNU·GPL, 리누스 토발즈의 리눅스와 실용주의, GPL·BSD·MIT 라이선스 전쟁, 마이크로소프트의 오픈소스 전향까지 오픈소스 40년의 역사를 다룬다."
---
