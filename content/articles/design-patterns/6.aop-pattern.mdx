...
subtitle: "얇은 핵심, 두터운 인프라"
description: "로깅·권한·트랜잭션·캐싱 같은 횡단 관심사를 핵심 로직에서 떼어내는 AOP를 다룬다. Join Point·Pointcut·Advice·Aspect 개념, NestJS Interceptor/Guard/Filter, Express 고차 함수 래핑, Next.js 함수형 AOP, Redis 캐싱·멱등성 조합, 적용 체크리스트를 예제로 설명한다."
