---
title: "Java 1.4 제네릭 없던 시절 — Object 캐스팅의 공포"
subtitle: "(String) list.get(0) 이 한 줄에 ClassCastException의 공포가 담겨있음"
description: "제네릭 이전 Java의 Object 캐스팅 지옥과 ClassCastException 위험을 살펴보고, Java 5 제네릭 도입부터 현재까지의 진화, Type Erasure, 와일드카드, TypeScript 타입 시스템과의 비교, 레거시 Java 리팩토링 방법을 다룬다."
---
