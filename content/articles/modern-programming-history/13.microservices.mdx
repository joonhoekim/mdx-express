---
title: "Episode 13: \"마이크로서비스: 모놀리스의 해체\""
subtitle: "거대한 시스템을 작은 조각으로 나누다"
description: "넷플릭스의 7년 MSA 전환기, 분산 모놀리스·잘못된 경계 설정 같은 함정들, MSA 도입을 판단하는 기준, API Gateway·Service Mesh·Saga 패턴 등 인프라의 진화를 다룬다."
---
