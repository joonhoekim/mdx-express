---
title: "Episode 11: \"도커: 컨테이너가 바꾼 세상\""
subtitle: "\"내 컴퓨터에서는 되는데\"를 영원히 묻어버리다"
description: "가상머신의 무거운 한계, 솔로몬 하이크스의 dotCloud와 Docker의 탄생, Dockerfile과 이미지 레이어링의 혁신, 쿠버네티스를 비롯한 컨테이너 오케스트레이션 전쟁까지 컨테이너 기술의 역사를 다룬다."
---
