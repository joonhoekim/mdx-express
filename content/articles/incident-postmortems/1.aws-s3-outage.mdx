---
title: "AWS S3 장애 (2017) — 타이핑 실수로 인터넷 절반이 죽은 날"
subtitle: "오타 하나로 미국 동부 인터넷을 4시간 동안 마비시킨 사상 최대의 클라우드 장애"
description: "2017년 AWS S3 장애의 사건 경위와 도미노 현상을 분석한다. 입력 값 검증 부재, 블래스트 레이디우스, 미검증 재시작 프로세스, 장애 대시보드의 자기 참조 문제를 짚고 입력 검증·SPOF 제거·모니터링 독립성 등의 교훈을 정리한다."
---
