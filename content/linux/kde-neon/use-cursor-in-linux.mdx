---
title: "리눅스에서 Cursor 사용하기"
subtitle: "AppImage가 바로 실행되지 않을 때"
description: "리눅스에서 Cursor AppImage를 실행하는 방법을 다룬다. fuse 의존성 설치, setuid 샌드박스 오류와 --no-sandbox 옵션, Gear Lever를 이용한 GUI 앱 등록, CLI와 GUI 실행 방식 비교, DBus 연결 오류 등의 문제 해결을 설명한다."
---
