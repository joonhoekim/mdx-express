---
title: "변경 전파 쌍: Shotgun Surgery와 Divergent Change"
subtitle: "하나를 고치면 열 개가 깨지거나, 열 가지 이유로 하나를 고치거나"
description: "Shotgun Surgery와 Divergent Change 코드 냄새의 정의와 역관계, 단일 책임 원칙 위반의 두 방향, 모으기와 나누기를 통한 해결 방법과 git 히스토리 기반 감지법을 TypeScript 예제로 설명한다."
---
