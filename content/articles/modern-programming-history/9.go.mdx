---
title: "Episode 9: \"Go의 단순함: 구글이 꿈꾼 서버 언어\""
subtitle: "\"Less is More\"의 철학으로 복잡성과 싸우다"
description: "구글 내부의 C++ 피로감, 그리즈머·파이크·톰슨이 설계한 Go의 의도적 단순함, 고루틴과 채널의 동시성 모델, Docker와 쿠버네티스로 Go가 클라우드 네이티브 표준 언어가 된 과정을 다룬다."
---
