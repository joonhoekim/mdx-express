...
subtitle: "AI가 코드를 쓰는 시대, 환경부터 다시 짠다"
description: "Claude Code, Zed IDE, tsgo를 중심으로 한 현대적 TypeScript 개발환경 구성을 다룬다. Rules와 Skills, MCP 서버 활용, Windows + WSL2 OS 선택, Dev Container를 권장하지 않는 이유까지 포함한다."
