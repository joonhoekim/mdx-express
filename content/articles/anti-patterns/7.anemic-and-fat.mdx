---
title: "Anemic과 Fat: 비즈니스 로직은 어디에 있어야 하는가"
subtitle: "너무 마른 모델과 너무 뚱뚱한 컨트롤러"
description: "Anemic Domain Model과 Fat Controller 안티패턴의 정의와 원인, Rich Domain Model과 레이어 분리를 통한 해결 방법, 도메인·서비스·컨트롤러의 책임 경계를 TypeScript 예제로 설명한다."
---
