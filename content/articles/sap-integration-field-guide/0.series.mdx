---
title: "SAP 연동 현장 가이드 — SAP 개발자가 아닌 개발자를 위한"
subtitle: "\"WSDL 던져줄 테니 붙여주세요\" 받고 화면이 멈춘 사람들을 위한 시리즈"
description: "SAP 바깥에서 SOAP으로 SAP에 연동해야 하는 웹·백엔드 개발자를 위한 8편 시리즈의 개요. 다루는 주제 범위와 독자 대상, 읽는 순서, 시리즈 공통 가정(ECC+MDG+PI/PO, SOAP 1.1)을 소개한다."
---
