---
title: "Episode 15: \"코드 제너레이션: 템플릿에서 LLM까지\""
subtitle: "반복 작업을 자동화하는 도구들의 진화"
description: "Make와 GUI 빌더부터 Rails 스캐폴딩, Yeoman, create-* 도구까지 코드 생성기의 역사, Reflection·매크로·Metaclass·Proxy 같은 메타프로그래밍, 로우코드/노코드와 AI 시대의 코드 생성, 그리고 인프라·소프트웨어·도메인 3계층으로 수렴하는 개발자 역할을 다룬다."
---
