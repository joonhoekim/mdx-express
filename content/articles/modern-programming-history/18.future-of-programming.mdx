---
title: "Episode 18: \"프로그래밍의 미래: 인간은 여전히 필요할까?\""
subtitle: "코드 작성부터 배포까지, 자동화의 끝은 어디인가"
description: "수동 프로그래밍부터 AGI까지 자동화의 4단계, 자동화 가능한 것과 불가능한 것의 경계, 코더에서 아키텍트·문제 해결자로 변하는 개발자의 역할, 프로그래밍 교육의 재정의와 기술·인간성의 균형을 다룬다."
---
