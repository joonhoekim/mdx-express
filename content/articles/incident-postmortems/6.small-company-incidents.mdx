---
title: "우리 회사에서도 터진다 — 소규모 장애 생존기와 교훈"
subtitle: "AWS S3도 터지고 CrowdStrike도 터지는데, 우리 회사라고 안 터지겠냐. 흔한 장애 유형들과 살아남는 법"
description: "스타트업·중소기업에서 자주 발생하는 장애 유형 — DB 연결 풀 고갈, 메모리 릭, 무한 루프, 잘못된 설정 변경, 배포 직후 장애 — 을 실제 코드와 함께 다루고, 최소한의 장애 대응 프로세스와 포스트모템 작성법을 제시한다."
---
