---
title: "스케일러블한 Next.js + NestJS + tRPC 아키텍처 설계"
subtitle: "타입 안전성을 잃지 않고 프론트와 백엔드를 분리하기"
description: "풀스택 Next.js의 한계를 넘어 Next.js 프론트엔드와 NestJS 백엔드를 tRPC로 연결하는 마이크로서비스 아키텍처를 다룬다. 아키텍처 구성과 tRPC 선택 이유, 계층별 설계, 독립적 스케일링 전략을 설명한다."
---
