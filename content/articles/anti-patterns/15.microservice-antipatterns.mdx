---
title: "마이크로서비스 안티패턴: 분산의 그림자"
subtitle: "마이크로서비스가 답이라고 했는데, 문제가 더 늘었어"
description: "Distributed Monolith·Nanoservices·Chatty I/O 세 마이크로서비스 안티패턴의 정의와 원인, 비동기 통신·Bounded Context·배치 로딩을 통한 해결 방법과 MonolithFirst 전략을 TypeScript 예제로 설명한다."
---
