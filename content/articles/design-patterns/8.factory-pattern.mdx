...
subtitle: "무엇을 만들지만 알려주면, 어떻게는 Factory가 안다"
description: "객체 생성 로직을 별도 클래스로 분리하는 Factory 패턴을 다룬다. new 반복과 초기화 지옥의 문제점, 알림 발송·리포트 생성 Factory 구현, Simple Factory와 Factory Method, NestJS DI·Next.js 함수형 접근, Registry 패턴 조합, 적용 시점을 예제로 설명한다."
