---
title: "3부: SSR/풀스택 무림"
subtitle: "\"어디서 싸울 거냐\"의 전략 선택"
description: "서버·클라이언트·풀스택 중 어디서 싸울지를 정하는 SSR/풀스택 프레임워크들을 다룬다. Next.js 용병대장, Astro 정적 세계의 도인, Remix 웹 표준 원리주의, SvelteKit, Nuxt를 무협으로 소개한다."
---
