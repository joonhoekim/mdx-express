...
import { Star, Code, Palette, Zap } from 'lucide-react';
...
코드를 아름답게 표시하고 복사 기능을 제공합니다.

<CodeBlock title="React 컴포넌트 예시" language="tsx" filename="Button.tsx">
...
<CodeBlock title='설치 명령어' language='bash'>
...
<Tabs defaultValue="react">
  ...
  <TabsContent value="react">
    <CodeBlock title="React 예시" language="tsx">
      {`import React from 'react'
...
export default App`}
  ...
  <TabsContent value="vue">
    <CodeBlock title="Vue 예시" language="vue">
      {`<template>
  <div>
    <h1>Hello Vue!</h1>
...
export default {
  ...
  <TabsContent value="angular">
    <CodeBlock title="Angular 예시" language="typescript">
