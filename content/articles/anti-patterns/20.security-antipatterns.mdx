---
title: "보안 안티패턴: 숨기면 안전할까?"
subtitle: "\"비밀번호를 코드에 넣어도 아무도 모를 거야\" — 아, GitHub가 알아요"
description: "Security through Obscurity와 Insecure Defaults 두 보안 안티패턴의 정의와 사례, Kerckhoffs 원칙·인증/인가·안전한 기본값 설정 등 올바른 보안 구현 방법과 배포 전 체크리스트를 TypeScript 예제로 설명한다."
---
