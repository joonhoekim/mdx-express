---
title: "안티패턴 가이드: \"이러면 망한다\""
subtitle: "코드에서 조직까지, 52가지 실패 패턴을 코드로 파헤치기"
description: "코드·설계·아키텍처·프로세스·보안·성능에 걸친 52가지 안티패턴을 TypeScript 예제로 다루는 시리즈의 개요와 전체 목차를 소개한다."
---
...
*안티패턴과 에러 사이 — 프레임워크가 숨긴 비용*

21. [N+1 쿼리와 지수적 복사](/docs/articles/anti-patterns/21.hidden-performance-traps) — ORM Lazy Loading + Exponential Copy + 스프레드 지옥
