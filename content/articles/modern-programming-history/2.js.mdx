---
title: "Episode 2: \"자바스크립트의 우연한 제국\""
subtitle: "10일 만에 만든 언어가 세상을 지배하기까지"
description: "브렌든 아이크의 10일간의 자바스크립트 개발기, AJAX와 jQuery를 통한 대중화, V8 엔진의 JIT 성능 혁명, Node.js와 NPM 생태계의 폭발까지 자바스크립트가 웹의 중심 언어가 된 과정을 다룬다."
---
