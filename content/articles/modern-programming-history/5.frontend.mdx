---
title: "Episode 5: \"jQuery에서 React까지: 프론트엔드 왕조의 흥망성쇠\""
subtitle: "DOM 조작의 고통에서 컴포넌트 천국까지"
description: "jQuery의 DOM 조작 민주화와 한계, AngularJS의 MVC 실험과 복잡성의 함정, React의 가상 DOM과 컴포넌트 혁명, Vue.js의 점진적 프레임워크 철학, 그리고 메타 프레임워크 시대까지 프론트엔드 15년사를 다룬다."
---
