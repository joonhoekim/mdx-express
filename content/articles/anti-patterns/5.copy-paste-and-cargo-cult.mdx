---
title: "복붙과 카고 컬트: 이해 없는 코딩"
subtitle: "StackOverflow에서 복사한 그 코드, 진짜 이해하고 붙인 거임?"
description: "Copy-Paste Programming과 Cargo Cult Programming 안티패턴의 정의와 차이, 코드 중복과 맹목적 패턴 적용의 문제, DRY 원칙과 자가진단 체크리스트를 TypeScript 예제로 설명한다."
---
