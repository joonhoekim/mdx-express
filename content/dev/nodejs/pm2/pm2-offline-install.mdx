---
title: "폐쇄망에서 PM2 오프라인 설치 가이드"
subtitle: "인터넷 없는 환경에서 npm 캐시로 PM2 설치하기"
description: "인터넷 접속이 제한된 폐쇄망에서 PM2와 PM2 Log Rotate 모듈을 설치하는 방법을 다룬다. 온라인 머신에서 npm 캐시를 만들어 옮기는 절차, 오프라인 설치 명령, 모듈 메타데이터 수동 작성, Log Rotate 설정 옵션을 설명한다."
---
