---
title: "Frontend-Backend 연결 편의성의 역사"
subtitle: "XML 지옥에서 End-to-End 타입 안전성까지"
description: "SOAP, Non-RESTful API, RESTful API, gRPC, tRPC로 이어지는 프론트엔드-백엔드 통신 방식의 변천을 양쪽 코드 예제로 비교하고, 각 단계의 개선점과 한계를 짚는다."
---
