...
subtitle: "핵심 컴포넌트는 본연의 일에만 집중하게"
description: "컴포넌트를 감싸 기능을 추가하는 Higher-Order Component 패턴을 다룬다. 반복되는 인증 체크의 문제점, withAuth·withRole·withDataFetching·조건부 렌더링 HOC 구현, HOC와 Custom Hooks 비교, Next.js Server Component HOC, 실무 팁과 적용 시점을 예제로 설명한다."
